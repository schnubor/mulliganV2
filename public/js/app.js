...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Quicksearch_vue__ = __webpack_require__(33);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__QuicksearchResult_vue__ = __webpack_require__(34);
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    computed: {
        manaCosts: function manaCosts() {
            ...
            var re = /(\{.*?\})/g;
            var splits = manaString.split(re);
            var manaCosts = [];
            ...
            try {
                for (var _iterator = splits[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    var manaCostLetter = split.slice(1, -1).toLowerCase();
                    var classString = 'ms-' + manaCostLetter;
